...
# LDAP
$ldap_url = "ldap://ldap.vagrant.local";
$ldap_starttls = false;
$ldap_binddn = "cn=readonly,ou=system,dc=brambleberry,dc=local";
$ldap_bindpw = "thegreenHawk13579";
$ldap_base = "dc=brambleberry,dc=local";
...
$shadow_options['shadow_expire_days'] = 180;
...
$keyphrase = "TbHWEGzVefKQ!sZzXc=@LxX6v";
